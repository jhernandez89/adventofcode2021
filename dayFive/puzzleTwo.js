...
const lines = {
  ...
  // TODO a lot of repeating code - needs to be broken out into reusable functions
  calculateOverlap: (dataFormatted) => {
    dataFormatted.forEach((xAndY, index) => {
      ...
      const is45DegreeAngle =
        Math.abs(beginningX - endX) === Math.abs(beginningY - endY);
      ...
      if (beginningX === endX) {
        ...
        //need to have four directions in diagnal (a combiantion of x increasing or decreasing and y increasing or decreasing)
